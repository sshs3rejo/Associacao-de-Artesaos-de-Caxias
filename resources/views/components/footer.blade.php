    ...
    <div class="max-w-7xl mx-auto px-4 py-4 md:py-6">
        <div class="flex flex-col md:grid md:grid-cols-4 gap-5 md:gap-8">
            ...
            <div class="md:col-span-1">
                <h4 class="text-xs font-bold mb-3 md:mb-4 uppercase tracking-widest text-accent/60 text-center md:text-left">Navegação</h4>
            ...
            <div class="md:col-span-1">
                ...
                <ul class="space-y-2.5 md:space-y-3 text-sm text-accent/70 list-none p-0 m-0 text-center md:text-left">
                    <li class="flex items-center justify-center md:justify-start gap-2 md:gap-3">
                        <i class="fas fa-map-marker-alt text-accent/60 text-xs"></i>
                        <a href="https://www.google.com/maps?q={{ config('association.latitude') }},{{ config('association.longitude') }}"
                           target="_blank" class="text-accent/70 no-underline hover:text-accent transition-colors truncate max-w-[220px] md:max-w-none inline-block align-middle">
                            {{ config('association.address') }}
                        </a>
                    </li>
                    <li class="flex items-center justify-center md:justify-start gap-2 md:gap-3">
                        <i class="fas fa-envelope text-accent/60 text-xs"></i>
                        <span class="truncate max-w-[220px] md:max-w-none inline-block align-middle">{{ config('association.email') }}</span>
                    </li>
                    <li class="flex items-center justify-center md:justify-start gap-2 md:gap-3">
                        <i class="fab fa-whatsapp text-accent/60 text-xs"></i>
