                ...
                <ul class="navbar-nav ms-auto gap-2 gap-xl-4 align-items-xl-center">
                    ...
                    @guest
                        <li class="nav-item mt-2 mt-xl-0">
                            <a class="nav-link fw-semibold px-4 py-2 rounded-pill border text-center" style="color: #F9F7D3; font-size: 1.1rem; border-color: rgba(249, 247, 211, 0.3) !important;" onmouseover="this.style.backgroundColor='rgba(249, 247, 211, 0.1)'; this.style.color='#ffffff'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#F9F7D3'" href="{{ route('login.form') }}">Login Admin</a>
                        </li>
                    @endguest
                    @auth
